        ...
        <div>
            ...
            <div id="add-forms">
                ...
                <select id="month-selector" name="instancia">
                    <option class="options">laranja</option>
                    <option class="options">verde</option>
                    <option class="options">azul</option>
                    <option class="options">marrom</option>
                    <option class="options">roxo</option>
                    <option class="options">amarelo</option>
                    <option class="options">outro</option>
                </select>
